...
class Profile(models.Model):
    ...
    #user_group = models.CharField(verbose_name="Группа", max_length=25)
    #home_adress = models.CharField(verbose_name="Домашний дрес", max_length=50)
# need extention with  country city index adress1 adress2
    #another_info = models.CharField(verbose_name="Дополнительная информация", max_length=100)
