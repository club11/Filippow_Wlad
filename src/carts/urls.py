...
urlpatterns = [
    ...
    path('booksincart_list/', carts_views.CartorderView.as_view(), name='booksincart_list'),
    #path('booksincart_detail/<int:pk>', carts_views.CartorderView.as_view(), name='booksincart_detail'),
]